...
conn = sqlite3.connect('examples90.db')
...
Student=("""CREATE TABLE Student( 
           ...
           Name varchar(255), 
           initials varchar(255) check (length(initials)>1), 
...
FOR EACH ROW
BEGIN 
DELETE FROM EVENT WHERE StartDate < DATETIME() ;
END;""")
# =============================================================================
...
EventRow=[]
cursor.execute(EventTrigger)

# =============================================================================
cursor.execute("INSERT INTO Event VALUES (1,'math Day', '2022-01-01 12:00:00', '2022-01-01 14:00:00')")
cursor.execute("INSERT INTO Event VALUES (2, 'CS Day', '2022-01-01 12:00:00', '2022-01-01 14:00:00')")
cursor.execute("INSERT INTO Event VALUES (3,'Biology Day', '2022-01-01 12:00:00', '2022-01-01 14:00:00') ")
cursor.execute("INSERT INTO Event VALUES (4,'English Day', '2022-01-01 12:00:00', '2022-01-01 14:00:00')")
cursor.execute("INSERT INTO Event VALUES (5,'French Day', '2022-01-01 12:00:00', '2022-01-01 14:00:00') ")
cursor.execute("INSERT INTO Event VALUES (6,'TRIGGER Day', '2020-01-01 12:00:00', '2020-01-01 14:00:00') ")
print("\nEvent Table")
...
for row in cursor.execute('SELECT DepartmentName FROM Major WHERE Major="Math"'):
       print(row)    
print("\nwhat are the names of the Events that take place during 2022?")
for row in cursor.execute('SELECT EventName FROM Event WHERE StartDate LIKE "2022%"'):
       print(row)  
